// 首页
import React, { useState } from 'react' //引用hooks里的useState
import Head from 'next/head'
import { Row, Col, List, Icon } from 'antd' //建立了—app.js全局引入了antdcss后，这边就可以按需引入了
...
import '../public/style/pages/index.css' //首页页面样式
import '../public/style/pages/common.css' //公共样式
import axios from 'axios' //引入请求
import Link from 'next/link'

const Home = (list) => {//这个list即下面请求数据拿过来的
          ...
          <List
            ...
            renderItem={item => (
              <List.Item>
                ...
                <div className="list_content">{item.introduce}</div>
              </List.Item>
            )}
          />
        </Col>
