...
import { Row, Col, List, Icon, Breadcrumb } from 'antd' //建立了—app.js全局引入了antdcss后，这边就可以按需引入了
...
import '../public/style/pages/list.css' //list样式
          ...
          <List
            ...
            renderItem={item => (
              <List.Item>
                ...
                <div className="list_content">{item.context}</div>
              </List.Item>
            )}
          />
        </Col>
